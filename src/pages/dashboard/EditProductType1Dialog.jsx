...
export default function EditProductType1Dialog({
  open,
  onClose,
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      // để parent show toast global; dialog tự đóng
      onClose?.();
    } catch (err) {
      console.error(err);
              ...
              >
                <Stack direction="row" spacing={1} alignItems="flex-start">
                  ...
                  <Typography sx={{ fontSize: 12.5, color: 'text.secondary' }}>
                    <b>Tip:</b> Avoid long names. Standardize (e.g., “Skincare”, “Haircare”…).
                  </Typography>
                </Stack>
              </Box>
            </Box>
      ...
      >
        ...
        <DialogContent sx={{ pt: 1 }}>
          <Typography sx={{ color: 'text.secondary', fontSize: 13.5 }}>
            Update Product Type 1 to <b>{titleName}</b>?
          </Typography>
