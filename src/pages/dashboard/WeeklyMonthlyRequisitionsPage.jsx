...
const headers = [
  ...
  { label: 'Item Description (EN)', key: 'itemDescriptionEN', sortable: true, width: 140, sticky: true, wrap: true },
  { label: 'Item Description (VN)', key: 'itemDescriptionVN', sortable: true, width: 140, sticky: true, wrap: true },
  { label: 'Old SAP Code', key: 'oldSAPCode', sortable: true, align: 'center', width: 70 },
  { label: 'Hana SAP Code', key: 'hanaSAPCode', sortable: true, align: 'center', width: 80 },
  { label: 'Supplier Description', key: 'supplierName', sortable: true, width: 130, wrap: true },
  { label: 'Depts', key: 'departmentRequisitions', width: 220 }, // Tăng lên 220px
  { label: 'Unit', key: 'unit', sortable: true, align: 'center', width: 50 },
  { label: 'Request Qty', key: 'totalRequestQty', sortable: true, align: 'center', width: 60 },
  ...
  { label: 'Currency', key: 'currency', sortable: true, align: 'center', width: 50 },
