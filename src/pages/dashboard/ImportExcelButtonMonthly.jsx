...
export default function ImportExcelButtonMonthly({ onImport, groupId, disabled }) {
  ...
  // ====== Style tokens (GIỐNG UI UX KIA) - KHÔNG ĐỤNG BUTTON ======
          ...
          <Stack direction="row" alignItems="center" justifyContent="space-between" spacing={2}>
            <Box>
              ...
              <Typography sx={{ opacity: 0.9, mt: 0.4, fontSize: 13 }}>
                Upload monthly requisition template (.xlsx / .xls)
              </Typography>
            </Box>
        ...
        <DialogContent sx={{ p: { xs: 2, sm: 2.5 } }}>
          <Box sx={{ ...subtleCardSx, p: 2 }}>
            ...
            <Typography sx={{ color: 'text.secondary', fontSize: 13, mt: 0.3 }}>
              Choose an Excel file and upload it to the system
            </Typography>
            ...
            >
              <Stack direction="row" spacing={1} alignItems="flex-start">
                ...
                <Typography sx={{ fontSize: 12.5, color: 'text.secondary' }}>
                  <b>Tip:</b> Make sure your sheet matches the template to avoid duplicates and invalid rows.
                </Typography>
              </Stack>
            </Box>
          </Box>
